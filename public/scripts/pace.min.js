...
!function () {
	...
	let Q = function (t, e) {
		for (const n in e) K.call(e, n) && (t[n] = e[n]);
		function r() {
			this.constructor = t;
		}
	...
	const V =
		[].indexOf ||
		function (t) {
			for (let e = 0, n = this.length; e < n; e++) if (e in this && this[e] === t) return e;
			return -1;
		};
	function Y() { }
	for (
		...
		p = function (t, e, n) {
			if (typeof t.addEventListener === "function") return t.addEventListener(e, n, !1);
			let r;
			"function" !== typeof t[`on${e}`] || typeof t[`on${e}`].eventListeners !== "object"
				? ((r = new s()),
		...
		j = function () {
			const t = arguments[0];
			const e = arguments[1];
			var n = arguments.length >= 3 ? J.call(arguments, 2) : [];
			...
			for (
				...
				if ((e = s[o]))
					for (t in e)
						K.call(e, t) &&
							((n = e[t]),
								r[t] != null && typeof r[t] === "object" && n != null && typeof n === "object"
									? d(r[t], n)
									: (r[t] = n));
			return r;
		},
		...
		Y.prototype.trigger = function () {
			...
			let o;
			let i = arguments[0];
			const a = arguments.length >= 2 ? J.call(arguments, 1) : [];
	...
	function et() {
		...
		if (F != null && T.ajax.trackWebSockets) {
			window.WebSocket = function (t, e) {
				const n = e != null ? new F(t, e) : new F(t);
	...
	function ot() {
		...
		let e;
		const n = this;
		(this.progress = (e = this.states[document.readyState]) != null ? e : 100),
	...
	(B = Error),
		...
		($.prototype.render = function () {
			...
			return (
				(!this.lastRenderedProgress || this.lastRenderedProgress | (this.progress !== 0) | 0) &&
		...
		(tt.prototype.on = function (t, e) {
			var n;
			return (n = this.bindings)[t] == null && (n[t] = []), this.bindings[t].push(e);
		}),
		(s = tt),
		...
		(y.ignore = function () {
			const t = arguments[0];
			let e = arguments.length >= 2 ? J.call(arguments, 1) : [];
		...
		(A = function (t) {
			...
			if (!L.length && T.ajax) {
				...
				if (((t = t.toUpperCase()), V.call(T.ajax.trackMethods, t) >= 0)) return !0;
			}
			return !1;
		}),
		Q(et, s),
		...
		(S = function () {
			...
			var e = t.url;
			if (!M(e))
				return y.running || (!1 === T.restartOnRequestAfter && A(i) !== "force")
					? void 0
					: ((o = arguments),
						typeof (e = T.restartOnRequestAfter || 0) === "boolean" && (e = 0),
						setTimeout(function () {
							var t;
							let e;
							let n;
							let r;
							var s = i === "socket" ? a.readyState < 1 : (s = a.readyState) > 0 && s < 4;
							if (s) {
		...
		(nt.prototype.watch = function (t) {
			...
			let n = t.request;
			var t = t.url;
			if (!M(t)) return (n = new (e === "socket" ? r : a)(n, this.complete)), this.elements.push(n);
		}),
				...
				(s = e.onreadystatechange),
					(e.onreadystatechange = function () {
						...
						return (
							...
							typeof s === "function" ? s.apply(null, arguments) : void 0
						);
					});
		}),
		(r = function (t, e) {
		...
		(it.prototype.tick = function (t, e) {
			return (
				(e = e == null ? j(this.source, "progress") : e) >= 100 && (this.done = !0),
				e === this.last
				...
				(e = 1 - (this.progress / 100) ** T.easeFactor),
		...
		(x = function () {
			...
			for (n = 0, s = (a = (i = T.extraSources) != null ? i : []).length; n < s; n++)
				...
				(e = O(function (t, e) {
					...
					for (
						...
						for (
							...
							i = E[g] != null ? E[g] : (E[g] = []),
							s = c = 0,
							l = (r = (p = C.elements) != null ? p : [C]).length;
							c < l;
							s = ++c
						)
							(o = r[s]),
								(f &= (o = i[s] != null ? i[s] : (i[s] = new v(o))).done),
								o.done || (h++, (a += o.tick(t)));
					return (
						(n = a / h),
						w.update(_.tick(t, n)),
